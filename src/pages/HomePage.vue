...
<template>
  <a-layout style="background-color: #E9EBEE; text-align: center">
    <a-layout-header :style="{'background-color': 'white', 'text-align': 'center'}">
              ...
              <a-typography>
                ...
                <a-typography-paragraph>
                  <ul>
                    ...
                    <li>
                      <a-typography-text>求职者经常将求职信与简历或就业申请一起发送，作为向潜在雇主介绍自己并解释自己是否适合所需职位的一种方式。雇主可能会寻找个性化且经过深思熟虑撰写的求职信，作为筛选对自己的职位不够感兴趣或缺乏必要的基本技能的申请人的一种方法</a-typography-text></li>
                  </ul>
                </a-typography-paragraph>
              </a-typography>
            </a-col>
