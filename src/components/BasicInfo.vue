...
// 省份信息
const provinces = computed(() => areaData.map((item) => item.name))
// 筛选后的城市信息
const cities = computed(() => areaData.filter((item) => item.name === basicInfoStore.province)
    .map(item => item.city)[0]);

// 如果省份修改了,则城市要对应调整
watch(() => basicInfoStore.province, (newValue, oldValue) => {
  if(newValue !== oldValue){
    basicInfoStore.city = null;
  }
})
...
<template>
  <a-form :model="basicInfo" style="width: 100%" :rules="rules" ref="formRef">
    ...
    <a-row>
      ...
      <a-col :xs="24" :sm="12" :md="{ span: 11, offset: 2 }" :lg="{ span: 11, offset: 2 }"
             :xl="{ span: 11, offset: 2 }">
    ...
    <a-row>
      ...
      <a-col :xs="24" :sm="12" :md="{ span: 15, offset: 1 }" :lg="{ span: 15, offset: 1 }"
             :xl="{ span: 15, offset: 1 }">
